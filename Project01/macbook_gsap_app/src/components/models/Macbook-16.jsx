...
Files: macbook-16.glb [639.28KB] > C:\Users\phili\Desktop\GitHub\ThreeJStutorial\Project01\macbook_gsap_app\public\models\macbook-16-transformed.glb [629.72KB] (1%)
...
import macbookModel16 from '../models/macbook-16-transformed.glb';

export default function MacbookModel16(props) {
  const { color } = useMacbookStore();
  const { nodes, materials, scene } = useGLTF(macbookModel16);
  ...
  useEffect(() => {
    scene.traverse((child) => {
      if (child.isMesh) {
        // Change color only if part name 
...
useGLTF.preload(macbookModel16)
